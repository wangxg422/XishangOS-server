...
// Mutate calls f(ctx, m).
func (f SysMenuFunc) Mutate(ctx context.Context, m codegen.Mutation) (codegen.Value, error) {
	if mv, ok := m.(*codegen.SysMenuMutation); ok {
		return f(ctx, mv)
	}
...
type SysUserFunc func(context.Context, *codegen.SysUserMutation) (codegen.Value, error)

// Mutate calls f(ctx, m).
func (f SysUserFunc) Mutate(ctx context.Context, m codegen.Mutation) (codegen.Value, error) {
	if mv, ok := m.(*codegen.SysUserMutation); ok {
		return f(ctx, mv)
	}
