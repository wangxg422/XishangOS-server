...
// The CommonConfigFunc type is an adapter to allow the use of ordinary
// function as CommonConfig mutator.
type CommonConfigFunc func(context.Context, *codegen.CommonConfigMutation) (codegen.Value, error)

// Mutate calls f(ctx, m).
func (f CommonConfigFunc) Mutate(ctx context.Context, m codegen.Mutation) (codegen.Value, error) {
	if mv, ok := m.(*codegen.CommonConfigMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *codegen.CommonConfigMutation", m)
}
