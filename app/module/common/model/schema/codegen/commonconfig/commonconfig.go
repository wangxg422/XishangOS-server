...
const (
	// Label holds the string label denoting the commonconfig type in the database.
	Label = "common_config"
	...
	// Table holds the table name of the commonconfig in the database.
	Table = "common_config"
)

// Columns holds all SQL columns for commonconfig fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the CommonConfig queries.
